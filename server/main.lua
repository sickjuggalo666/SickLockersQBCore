...
QBCore.Functions.CreateCallback('SickEvidence:getInventory', function(source, cb, evidenceID)
...
QBCore.Functions.CreateCallback('SickEvidence:getOtherInventories', function(source, cb, Otherlocker)
...
QBCore.Functions.CreateCallback('SickEvidence:getLocker', function(source, cb, lockerID)
...
QBCore.Functions.CreateCallback('SickEvidence:getPlayerName', function(source,cb)
  local xPlayer = ESX.GetPlayerFromId(source)
